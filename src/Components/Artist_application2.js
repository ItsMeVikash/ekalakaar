...
export default function Artist_application2() {
    ...
    const handleSubmit = (e)=>{
        ...
        async function fetchData(){
            let opportunityAllData = await fetch("http://ekalakaar.com:4000/api/getAllOpportunities");
            ...
            let singleobj = arrayrev.find(each=>each._id === params.id);
             ...
             let appliedoppo = await fetch(`http://ekalakaar.com:4000/api/user/apply/opportunity/${params.id}`,{
                method: 'PUT',
