...
export default function Edit_Opportunity() {
    ...
    useEffect(()=>{
        async function fetchData(){
            let opportunities = await fetch(`http://ekalakaar.com:4000/api//user/getOpportunity/${oppoId.id}`);
    ...
    const handleupdateoppo = async(e)=>{
        ...
        const opportunityDataww = {
          ...
          const id = oppoId.id;
          let result = await fetch(`http://ekalakaar.com:4000/api/patron/update/opportunity/${id}`,{
            method:"PUT",
