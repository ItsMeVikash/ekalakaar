...
export default function View_artist_detail() {
  ...
  const handleHire = async () => {
    ...
    let storeHire = await fetch(
      `http://ekalakaar.com:4000/api/user/hire/opportunity/${oppoid}/${artistid}`,
      {
        method: "POST",
        headers: {
  ...
  useEffect(() => {
    ...
    let getApplicantsData = async () => {
      let data = await fetch("http://ekalakaar.com:4000/api/getAllOpportunities");
    ...
    let getArtist = async () => {
      let data = await fetch("http://ekalakaar.com:4000/api/getAllUsers");
      let json = await data.json();
  ...
  const handleShortlist = async () => {
    ...
    let storeshortlist = await fetch(
      `http://ekalakaar.com:4000/api/user/shortlist/opportunity/${oppoid}/${artistid}`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
  ...
  const handleReject = async () => {
    ...
    let rejection = await fetch(
      `http://ekalakaar.com:4000/api/user/reject/opportunity/${oppoid}/${artistid}`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
