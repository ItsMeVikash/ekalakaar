...
export default function View_shortlisted_artist() {
  ...
  useEffect(()=>{
      async function fetchData(){
         let opportunityAllData = await fetch(`http://ekalakaar.com:4000/api/patron/opportunity/all/${posted_by_email}`);
  ...
  useEffect(()=>{
    async function fetchData(){
       let opportunityAllData = await fetch("http://ekalakaar.com:4000/api/getAllUsers");
        opportunityAllData = await opportunityAllData.json(); 
